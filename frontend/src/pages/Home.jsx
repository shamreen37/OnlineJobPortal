...
if (SearchVal === "") { setjoblist(joblist); return; }
const filterBySearch = joblist.filter((job) => {
    if (job.profile.toLowerCase()
        .includes(SearchVal.toLowerCase())) { return job; }
})
setjoblist(filterBySearch);
}
          ...
          <div className="row">
            ...
            <div className="col-md-3 homecol-1 p-2">
              <div className="card text-center py-3 box-shadow border-0">
                ...
                <div className="card-body pt-0">
                  ...
                  <p><i class="fa-solid fa-school"></i> {candidate.location}</p>
                  <p> <i class="fa-solid fa-location-dot"></i> {candidate.profile}</p>
            ...
            <div className="col-md-6 homecol-2 p-2">
              <div className="search-home-div box-shadow p-3">
                ...
                <p className='text-light'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate iusto odio itaque a optio reiciendis.</p>
                <form className="d-flex">
                  <input className="form-control search-home-input me-2" type="search" placeholder="Search your dream job here" aria-label="Search" onChange={e => setSearchVal(e.target.value)} />
                  <button className="btn btn-light search-btn-home" type="submit" onClick={Searchpattern}>Search</button>
                </form>
              </div>
              ...
              <div className="latest-jobs-home d-flex w-100 justify-content-between">
                  <div className="latest-jobs-home-inner-div">
                    <h5>{job.profile}</h5>
                    <p>{job.companyName}  </p>
                    <p> <span> &#8226;{job.location}</span>  <span> &#8226; &#x20B9;{job.salary} </span>
